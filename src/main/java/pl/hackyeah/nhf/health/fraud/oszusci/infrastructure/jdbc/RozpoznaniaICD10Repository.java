...
public class RozpoznaniaICD10Repository {
    ...
    public List<RozpoznanieWithJPGGroup> getICD10WithJPGGroupByYears() {
        return jdbcTemplate.query("SELECT w.Kod, w.Rok, sum(w.liczba_wystapien) FROM (\n" +
                ...
                "GROUP BY w.Kod, w.Rok order by w.Kod, w.Rok desc", (rs, rowNum)-> new RozpoznanieWithJPGGroup(rs.getNString(1), rs.getInt(2), (int)rs.getDouble(3)));
    }
}
