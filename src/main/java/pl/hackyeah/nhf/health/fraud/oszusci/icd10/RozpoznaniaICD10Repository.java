...
public class RozpoznaniaICD10Repository implements Repo {
    ...
    public List<pl.hackyeah.nhf.health.fraud.oszusci.icd10.domain.RozpoznanieWithJPGGroup> getICD10WithJPGGroupByYears() {
        //@formatter:off
        return jdbcTemplate.query(
                "SELECT w.Kod, w.Rok, sum(w.liczba_wystapien) " + 
                    ...
                    "GROUP BY w.Kod, w.Rok order by w.Kod, w.Rok desc", (rs, rowNum)-> new pl.hackyeah.nhf.health.fraud.oszusci.icd10.domain.RozpoznanieWithJPGGroup(rs.getString(1), rs.getInt(2), (int)rs.getDouble(3)));
        //@formatter:on
    }
}
